...
function gymfitness_setup(){
  ...
  function gymfitness_scripts_styles(){
    ...
    if (is_front_page()) {
      wp_enqueue_style('swiper-css', "https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css", array(), '11.1.12');
    }
    wp_enqueue_style('style', get_stylesheet_uri(), array('normalize'), '1.0.0');

    // Archivos JS
    // También puede se puede integrar 'jquery' ( o cualquier otra librería) pasándola como dependencia en el array del archivo de js. Quedaría así: wp_enqueue_script('lightboxjs',get_template_directory_uri() . '/js/lightbox.min.js', array('jquery'), '2.11.4', true); Funciona igual. 
    ...
    if (is_front_page()) {
      ...
      wp_enqueue_script('swiper-js', 'https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js', array(), '11.1.12', true);
    }
  ...
  // Crear Shortcodes
  function gymfitness_ubicacion_shortcodes(){
    ?>
      <div class="mapa">
        <?php 
          // 'contacto' es el slug (identificador único interno) de la página 
          if (is_page('contacto')) {
            the_field('ubicacion');
          }
        ?>
    ...
    <?php
    echo do_shortcode('[contact-form-7 id="bb771c6" title="Formulario de contacto 1"]');
  }
  add_shortcode('gymfitness_ubicacion', 'gymfitness_ubicacion_shortcodes');
